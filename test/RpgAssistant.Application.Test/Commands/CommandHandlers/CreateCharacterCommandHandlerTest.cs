...
public class CreateCharacterCommandHandlerTest
{
    ...
    public CreateCharacterCommandHandlerTest()
    {
        ...
        _sut = new CreateCharacterCommandHandler(transactionFactory, _characterRepository, logger);
    }
    ...
    public async Task InvokeAsync_WhenRepositoryThrows_ReturnsExceptionAndRollsBack()
    {
        ...
        _characterRepository
            .CreateAsync(Arg.Any<IAsyncTransaction>(), Arg.Any<RpgAssistant.Domain.Entities.Characters.Commands.CreateCharacter>())
